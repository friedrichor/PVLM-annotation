...
parser.add_argument("--no_img", action="store_true", default=False)  # 预训练时 no_img == True 不使用图像

parser.add_argument("--dataset", type=str, default='t2017')  # 'mvsa-s'
parser.add_argument("--few_shot_file", type=str, default='few-shot.tsv')  # 'few-shot1.tsv'
